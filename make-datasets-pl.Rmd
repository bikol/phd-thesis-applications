...
library(tikzDevice)
tikz(file="4-malig-vs-missing.tex", sanitize = T, height = 3, width = 6,
...
levels(df$MalignancyCharacter) = c("niezłośliwy", "złośliwy")
...
p = ggplot(data=df, aes(x=Range, y=..count.., fill=MalignancyCharacter, ymax=max(..count..))) +
    ...
    xlab("Procent brakujących danych") +
    geom_text(aes(label=..count.., y= ..count..+5), stat= "bin",
              position= position_dodge(width=0.9), size=3)  +
    scale_fill_brewer(name="Charakter złośliwości", palette="Paired") +
    ylab("Liczba")
...
tikz(file="4-training-vs-test.tex", sanitize = T, height = 2.75, width = 5,
     documentDeclaration = '\\documentclass[11pt,a4paper,oldfontcommands]{memoir}')
...
levels(df$set) = c("zbiór optymalizacyjny", "zbiór testowy")
